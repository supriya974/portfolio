...
import profileImage from "../../assets/profile.png.jpg"; // make sure path is correct

const About = () => {
  const words = ["Fullstack Developer", "Problem Solver", "Coder"];
    ...
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 flex justify-center md:justify-end pl-5">
          <Tilt
            className="w-48 h-48 sm:w-64 sm:h-64 md:w-[30rem] md:h-[30rem] border-4 border-purple-900 rounded-full"
            tiltMaxAngleX={20}
            tiltMaxAngleY={20}
            perspective={1000}
            scale={1.05}
